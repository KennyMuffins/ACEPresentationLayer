      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        <div className="container">
          ...
          <ul className="nav navbar-nav mr-auto">
            ...
            <NavLink to="/processtemplatelist" role="navigation link" className="nav-link">
                <i className="fa fa-calendar"></i>&nbsp;
                Processes
            </NavLink>
            <NavLink to="/processinstancelist" role="navigation link" className="nav-link">
                <i className="fa fa-calendar"></i>&nbsp;
                Running Instances
            </NavLink>
            <NavLink to="/formbuildercomponent" role="navigation link" className="nav-link">
                <i className="fa fa-calendar"></i>&nbsp;
                Form Builder
            </NavLink>
            <NavLink to="/formgiftevaluationjson" role="navigation link" className="nav-link">
                <i className="fa fa-calendar"></i>&nbsp;
                Gift Evaluation Form
            </NavLink>
            <NavLink to="/formadder" role="navigation link" className="nav-link">
                <i className="fa fa-calendar"></i>&nbsp;
                From Adder
            </NavLink>
          </ul>
